  ...
  return (
    <div className={s.root}>
      ...
      <div
        className={s.cloud}
        style={{
          transform: `translate(${screenY * 0.02}px, ${screenX * 0.04}px)`,
        }}>
      ...
      <div
        ...
        style={{
          transform: `translate(${screenY * 0.01}px, ${screenX * 0.02}px)`,
        }}>
      ...
      <div
        ...
        style={{
          transform: `translate(${screenY * 0.01}px, ${screenX * 0.1}px)`,
        }}>
